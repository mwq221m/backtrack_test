...
if __name__=='__main__':
    ...
    st4=time.time()
    obj4 = PossibilityBacktrackwithPruning(data=data, fault_idx1=0, fault_idx2=7)
    obj4.backtrack(startindex=0)
    ed4=time.time()

    st5=time.time()
    obj5 = PossibilityBacktrackwithPruning(data=data, fault_idx1=1, fault_idx2=2)
    obj5.backtrack(startindex=0)
    ed5=time.time()

    st6=time.time()
    obj6 = PossibilityBacktrackwithPruning(data=data, fault_idx1=1, fault_idx2=6)
    obj6.backtrack(startindex=0)
    ed6=time.time()

    st7=time.time()
    obj7 = PossibilityBacktrackwithPruning(data=data, fault_idx1=2, fault_idx2=6)
    obj7.backtrack(startindex=0)
    ed7=time.time()

    st8=time.time()
    obj8 = PossibilityBacktrackwithPruning(data=data, fault_idx1=2, fault_idx2=7)
    obj8.backtrack(startindex=0)
    ed8=time.time()

    st9=time.time()
    obj9 = PossibilityBacktrackwithPruning(data=data, fault_idx1=3, fault_idx2=6)
    obj9.backtrack(startindex=0)
    ed9=time.time()

    st10=time.time()
    obj10 = PossibilityBacktrackwithPruning(data=data, fault_idx1=4, fault_idx2=5)
    obj10.backtrack(startindex=0)
    ed10=time.time()

    st11=time.time()
    obj11 = PossibilityBacktrackwithPruning(data=data, fault_idx1=4, fault_idx2=6)
    obj11.backtrack(startindex=0)
    ed11=time.time()

    st12=time.time()
    obj12 = PossibilityBacktrackwithPruning(data=data, fault_idx1=4, fault_idx2=8)
    obj12.backtrack(startindex=0)
    ed12=time.time()

    st13=time.time()
    obj13 = PossibilityBacktrackwithPruning(data=data, fault_idx1=5, fault_idx2=6)
    obj13.backtrack(startindex=0)
    ed13=time.time()

    st14=time.time()
    obj14 = PossibilityBacktrackwithPruning(data=data, fault_idx1=5, fault_idx2=8)
    obj14.backtrack(startindex=0)
    ed14=time.time()

    st15=time.time()
    obj15 = PossibilityBacktrackwithPruning(data=data, fault_idx1=6, fault_idx2=7)
    obj15.backtrack(startindex=0)
    ed15=time.time()

    st16=time.time()
    obj16 = PossibilityBacktrackwithPruning(data=data, fault_idx1=6, fault_idx2=8)
    obj16.backtrack(startindex=0)
    ed16=time.time()

    st17 = time.time()
    obj17 = PossibilityBacktrackwithPruning(data=data, fault_idx1=6, fault_idx2=9)
    obj17.backtrack(startindex=0)
    ed17 = time.time()

    st18 = time.time()
    obj18 = PossibilityBacktrackwithPruning(data=data, fault_idx1=6, fault_idx2=10)
    obj18.backtrack(startindex=0)
    ed18 = time.time()

    st19 = time.time()
    obj19 = PossibilityBacktrackwithPruning(data=data, fault_idx1=6, fault_idx2=11)
    obj19.backtrack(startindex=0)
    ed19 = time.time()
    ...
    for i in obj17.result:
        if i not in result_list:
            result_list.append(i)

    for i in obj18.result:
        if i not in result_list:
            result_list.append(i)

    for i in obj19.result:
        if i not in result_list:
            result_list.append(i)
    ...
    time_temp=np.max([ed1-st1,ed2-st2,ed3-st3,ed4-st4,ed5-st5,ed6-st6,ed7-st7,ed8-st8,ed9-st9,ed10-st10,ed11-st11,ed12-st12,ed13-st13,ed14-st14,ed15-st15,ed16-st16,ed17-st17,ed18-st18,ed19-st19])+ed-st
